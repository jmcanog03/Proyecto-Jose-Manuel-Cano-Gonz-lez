...
<header>
    ...
    <div class="product-img-container">
        <img src="https://camisetasfuutbol.eu/wp-content/uploads/2024/02/6_f57584f3-a563-4398-9dd0-2e6741a9e878.png" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Chándal del FC Barcelona Rojo</h2>
        <p>50,00 €</p>
        <form>
