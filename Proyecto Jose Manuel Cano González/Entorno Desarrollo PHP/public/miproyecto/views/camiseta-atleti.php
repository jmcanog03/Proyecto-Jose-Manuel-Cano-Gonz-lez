...
<header>
    ...
    <div class="product-img-container">
        <img src="https://realjasefootball.com/cdn/shop/files/2246655013D626F317303C93BCB3E580.jpg?v=1701469830&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Casmiseta Local Atletico de Madrid 23/24</h2>
        <p>22,00 €</p>
        <form>
