...
<header>
    ...
    <div class="product-img-container">
        <img src="https://realjasefootball.com/cdn/shop/files/IMG-2557.webp?v=1701493601&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
    <h2>Casmiseta Local FC Barcelona 23/24</h2>
    <p>22,00 €</p>
    <form method="post" action='/miproyecto/index.php?controller=carritoController&action=addProductToCart'>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="parche" name="parche">
