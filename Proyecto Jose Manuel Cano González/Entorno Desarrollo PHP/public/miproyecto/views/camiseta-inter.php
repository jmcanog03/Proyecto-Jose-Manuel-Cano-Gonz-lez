...
<header>
    ...
    <div class="product-img-container">
        <img src="https://realjasefootball.com/cdn/shop/files/IMG-4061.jpg?v=1704616135&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Camiseta Retro del Inter de Milan 09/10</h2>
        <p>37,00 €</p>
        <form>
