...
<header>
    ...
    <div class="product-img-container">
        <img src="https://camisetasfuutbol.eu/wp-content/uploads/2024/02/28_bc2ca42e-1d13-4525-b7e7-70c6c3189658.png" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Chándal del PSG Oscuro</h2>
        <p>50,00 €</p>
        <form>
