...
<header>
    ...
    <div class="product-img-container">
        <img src="https://realjasefootball.com/cdn/shop/files/Retro-Barcelona-1011-home-1.webp?v=1701516867&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Camiseta Retro del FC Barcelona 10/11</h2>
        <p>37,00 €</p>
        <form>
