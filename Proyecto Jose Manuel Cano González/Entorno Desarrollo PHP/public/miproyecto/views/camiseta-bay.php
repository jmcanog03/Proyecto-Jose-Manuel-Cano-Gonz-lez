...
<header>
    ...
    <div class="product-img-container">
        <img src=https://realjasefootball.com/cdn/shop/files/3307b4b5b5a62dda88f29875448ac94e4.jpg?v=1701702736&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Casmiseta Local Bayern.M 23/24</h2>
        <p>22,00 €</p>
        <form>
