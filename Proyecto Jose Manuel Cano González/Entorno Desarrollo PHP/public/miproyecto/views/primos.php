...
foreach ($data as $producto) {
    if ($producto['categoria'] == 'camiseta') {
        ...
        echo '<form action="index.php?controller=productoController&action=addCarrito&id='.$producto['id_producto'].'" method="post">';
        ...
        echo '</div>';
        echo '<button type="submit" class="btn btn-outline-success btn-custom" data-bss-hover-animate="rubberBand">Añadir AL carrito</button>';
