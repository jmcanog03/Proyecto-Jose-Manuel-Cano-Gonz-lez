...
<header>
    ...
    <div class="product-img-container">
        <img src="https://camisetasfuutbol.eu/wp-content/uploads/2024/02/26_b78be86e-2b52-4c6e-b0dd-7a48c5c84eb5.png" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Chándal del Milan Negro</h2>
        <p>50,00 €</p>
        <form>
