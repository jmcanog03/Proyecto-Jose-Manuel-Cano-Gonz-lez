...
<header>
    ...
    <div class="product-img-container">
        <img src="https://camisetasfuutbol.eu/wp-content/uploads/2024/02/10_1119a56f-9450-4f6c-a134-da338ac665bc.png" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Chándal del Chelsea FC</h2>
        <p>50,00 €</p>
        <form>
