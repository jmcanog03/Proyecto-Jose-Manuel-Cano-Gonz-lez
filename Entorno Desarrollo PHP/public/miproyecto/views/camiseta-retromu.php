...
<header>
    ...
    <div class="product-img-container">
        <img src="https://realjasefootball.com/cdn/shop/files/5675ed5dc9005b2a1feedc580a34425e2.jpg?v=1704395825&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Camiseta Retro del Manchester United 07/08</h2>
        <p>37,00 €</p>
        <form>
