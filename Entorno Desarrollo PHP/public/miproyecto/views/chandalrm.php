...
<header>
    ...
    <div class="product-img-container">
        <img src="https://camisetasfuutbol.eu/wp-content/uploads/2024/02/20_d2452bfd-b6e4-4cb2-bd39-b458c35e1459.png" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Chándal del Real Madrid Negro</h2>
        <p>50,00 €</p>
        <form>
