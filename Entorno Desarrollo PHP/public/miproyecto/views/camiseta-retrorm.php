...
<header>
    ...
    <div class="product-img-container">
        <img src="https://realjasefootball.com/cdn/shop/files/Retro-Real-Madrid-9899-away-3.webp?v=1701516748&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Camiseta Retro del Real Madrid 98/99</h2>
        <p>37,00 €</p>
        <form>
