...
<header>
    ...
    <div class="product-img-container">
        <img src="https://realjasefootball.com/cdn/shop/files/366558399152f42c8e35d6a412ba8c0fa.jpg?v=1704395675&width=823" alt="Camiseta Madrid" class="product-img">
    </div>

    <!-- Detalles del producto -->
    <div class="product-details">
        <h2>Camiseta Retro del Arsenal 91/92</h2>
        <p>37,00 €</p>
        <form>
